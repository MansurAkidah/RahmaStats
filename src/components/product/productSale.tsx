      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Card>
            ...
            <CardContent >
  <Box sx={{ height: 300, overflow: 'auto', flexDirection: 'column' }}>
    <Stack spacing={2}>
      {cart.map(item => (
        <Box
          key={item.id}
        ...
        >
          <Typography fontWeight="600" sx={{ mb: 1 }}>{item.name}</Typography>
          <Typography fontWeight="300" sx={{ mb: 1 }}>{item.price}</Typography>
          <Divider sx={{ my: 1 }} />
